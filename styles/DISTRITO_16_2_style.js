...
var style_DISTRITO_16_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("SECCION") !== null) {
        ...
        function rules_DISTRITO_16_2(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_DISTRITO_16_2rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_DISTRITO_16_2rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_DISTRITO_16_2rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_DISTRITO_16_2rule3_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_DISTRITO_16_2(feature, value);
        ;
