...
var style_VISTAGENERAL_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("SECCION") !== null) {
        ...
        function rules_VISTAGENERAL_5(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_VISTAGENERAL_5rule0_eval_expression(context)) {
                      return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.4)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 2.28}),fill: new ol.style.Fill({color: 'rgba(0,0,255,0.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
                    }
                    else if (exp_VISTAGENERAL_5rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_VISTAGENERAL_5rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_VISTAGENERAL_5rule3_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_VISTAGENERAL_5(feature, value);
        ;
