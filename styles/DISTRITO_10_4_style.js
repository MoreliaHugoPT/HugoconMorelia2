...
var style_DISTRITO_10_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("SECCION") !== null) {
        ...
        function rules_DISTRITO_10_4(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_DISTRITO_10_4rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_DISTRITO_10_4rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_DISTRITO_10_4rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_DISTRITO_10_4rule3_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_DISTRITO_10_4(feature, value);
        ;
