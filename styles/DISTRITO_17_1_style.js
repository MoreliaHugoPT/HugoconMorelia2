...
var style_DISTRITO_17_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("SECCION") !== null) {
        ...
        function rules_DISTRITO_17_1(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_DISTRITO_17_1rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_DISTRITO_17_1rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_DISTRITO_17_1rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_DISTRITO_17_1rule3_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_DISTRITO_17_1(feature, value);
        ;
